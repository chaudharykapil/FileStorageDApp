...
const Level2 = () => {
    ...
    const storePassword = ()=>{
        window.localStorage.setItem("login_temp_password2",password)
        navigate("/auth/signin/level3")
    ...
    <>
      ...
      <div className="file-container" style={{height:"100vh",display:"flex",rowGap:"2rem",flexDirection:"column",justifyContent:"center", alignItems:"center"}}>
        <div style={{textAlign:"center",marginBottom:"3rem"}}>
            <h2 style={{color:"white"}}>Enter the Password for your Account to Login</h2>
        </div>
